...
qa_prompt_template = '''You are given a screening interview question for a job (delimited by <qse></qse>) and a candidate's answer to that question (delimited by <ans></ans>). 
