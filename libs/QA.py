...
ques_gen_prompt_template = '''Create 5 Unique, conceptual questions for screening interview using the following Job Description: {jobdescription} 
...
qa_chain = LLMChain(
    llm=qa_llm,
    prompt=PromptTemplate.from_template(ques_gen_prompt_template)
)
